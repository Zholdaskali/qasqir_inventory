...
public class CategoryService {
    ...
    @Transactional
    public Category syncingWith1CByCategoryName(String categoryName) {
        try {
            ...
            throw new RuntimeException("Ошибка при изменении проверке категории");
        }
    }
}
