...
public class TicketService {
    ...
    @Transactional
    public void createTicket(String comment, BigDecimal quantity, Long inventoryId, Long createBy, String type, Long documentId) {
        ...
        ticket.setStatus(Status.ACTIVE.getCode());
    ...
    public String allowedTicket(Long ticketId, Long managerId) {
        ...
        ticket.setStatus(Status.ALLOWED.name());
